...
public class tiny_gp {
    ...
    int print_indiv(char[] buffer, int buffercounter, StringBuilder sb) {
        int a1 = 0, a2;
    ...
    void stats(double[] fitness, char[][] pop, int gen, CSVWriter csv) {
        int i, best = rd.nextInt(POPSIZE);
        int node_count = 0;
        fbestpop = fitness[best];
        favgpop = 0.0;
        StringBuilder best_indiv = new StringBuilder();
        for (i = 0; i < POPSIZE; i++) {
